...
# were MEASURED on 9 Sep 2026, not estimated: 910 in this repo, and 741 from an rsync copy
...
EXPECTED_CHECKS = 910 if CLIENT_DRAWINGS else 741
MIN_CHECKS = 897 if CLIENT_DRAWINGS else 729
