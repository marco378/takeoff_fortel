...
# were MEASURED on 9 Sep 2026, not estimated: 911 in this repo, and 741 from an rsync copy
...
EXPECTED_CHECKS = 1043 if CLIENT_DRAWINGS else 842
MIN_CHECKS = 1030 if CLIENT_DRAWINGS else 829
